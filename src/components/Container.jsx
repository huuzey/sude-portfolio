    ...
    <div className={`flex flex-col realto  `} style={{ color: currentColor }}>
      ...
      <div className="flex ml-4 relative   ">
        ...
        >
          ...
          /> */}
          <h
            className={`text-2xl mb-2 mt-2 ml-2  rounded-md px-2 py-1`}
            data-aos="fade-right"
          >
            ✅. Murid Hussien
          </h>
          <h
            ...
            data-aos="fade-right"
          >
            ✅TOP RATED PLUS Professional Video Editor
          </h>
          <img
            data-aos="fade-right"
            alt="mine"
          ...
          <h
            className={`text-2xl mb-2 mt-2 ml-2 bgb   rounded-md px-2 py-1`}
            data-aos="fade-right"
          >
          ...
          <h
            ...
            data-aos="fade-right"
          >
            ✅.You want to grab your audiences attention in less than 30 seconds
            and retain them until the end so, this is what I have been providing
            for the last 3 years.
          </h>

          <div className={`sm:ml-0  md:ml-28 rounded-b-lg   `}>
            <h
              className={`text-xl mb-2 mt-2   rounded-md px-2 py-1`}
              data-aos="fade-right"
            >
              ✅.Adobe Premiere Pro
            </h>
            ...
            <p data-aos="fade-right" className="  px-2 py-1 rounded-md mt-3">
              ✔️.Youtube videos
            </p>
            <p data-aos="fade-right" className="  px-2 py-1 rounded-md mt-3">
              ✔️.Youtube shorts
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 mx-2  w-full gap-2 h-full mt-4">
